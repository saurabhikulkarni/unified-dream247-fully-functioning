...
import 'package:unified_dream247/features/shop/entry_point.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
      ...
      return MaterialPageRoute(
        builder: (context) {
          ...
          if (args is Map<String, dynamic>) {
            ...
            return ProductDetailsScreen(isProductAvailable: args);
          }
    ...
    // Removed onSaleScreenRoute: sale screen deprecated
    ...
    case refundPolicyScreenRoute:
      return MaterialPageRoute(
        builder: (context) => const RefundPolicyScreen(),
      );
    case shippingPolicyScreenRoute:
      return MaterialPageRoute(
    ...
    case orderConfirmationScreenRoute:
      return MaterialPageRoute(
        builder: (context) => const OrderConfirmationScreen(order: null),
      );
    ...
    case addAddressScreenRoute:
      ...
      return MaterialPageRoute(
        builder: (context) => AddAddressScreen(
          ...
          houseNumber: args?['houseNumber'] ?? args?['addressLine1'],
          roadName: args?['roadName'] ?? args?['addressLine2'],
    ...
    case addressSelectionScreenRoute:
      return MaterialPageRoute(
