...
class ApiConfig {
  ...
  static String get shopBaseUrl {
    ...
    const override =
        String.fromEnvironment('SHOP_BACKEND_URL', defaultValue: '');
  ...
  static String get shopRefreshTokenEndpoint =>
      '$shopApiUrl/auth/refresh-token';
  static String get shopValidateTokenEndpoint =>
      '$shopApiUrl/auth/validate-token';
  static String get shopLogoutEndpoint => '$shopApiUrl/auth/logout';

  // Shop API Endpoints - Wallet
  // shop-tokens-only endpoint removed - returns 404
  ...
  static const String _fantasyProdUrl =
      'http://134.209.158.211:4000'; // TODO: Update with SSL domain when ready

  /// Get Fantasy Backend base URL
  static String get fantasyBaseUrl {
    // Allow override via dart-define
    const override =
        String.fromEnvironment('FANTASY_API_URL', defaultValue: '');
    if (override.isNotEmpty) return override;
  ...
  static String get fantasyMyJoinContestUrl =>
      '$fantasyBaseUrl/myjoined-contest/';
  static String get fantasyMyTeamsUrl => '$fantasyBaseUrl/getmyteams/';
  static String get fantasyCompletedMatchUrl =>
      '$fantasyBaseUrl/completed-match/';
  ...
  static String get fantasyUserLoginEndpoint =>
      '${fantasyUserUrl}add-temporary-user'; // /user/add-temporary-user (creates user)
  // fantasyWalletBalanceEndpoint removed - deprecated
  // fantasyShopTokensEndpoint removed - returns 404 (RESTORED FOR APP PROVIDER)
  static String get fantasyShopTokensEndpoint =>
      '${fantasyUserUrl}user-wallet-details';
  static String get fantasyUnifiedHistoryEndpoint =>
      '$fantasyBaseUrl/api/user/wallet/unified-history';
  static String get fantasySyncShopTokensEndpoint =>
      '$fantasyBaseUrl/api/user/wallet/sync-shop-tokens-to-shop';
  static String get fantasyRefreshTokenEndpoint =>
      '$fantasyBaseUrl/api/auth/refresh-token';
  static String get fantasyVersionEndpoint => '${fantasyUserUrl}get-version';
